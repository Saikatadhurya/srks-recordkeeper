	...
	<section id="banner" >
		<section class="container">
			...
			<section class="row">
				<div class="col-md-6">
					<div class="headings">
						<h1 class="wow animated fadeInDown">STUDENT RECORD KEEPING SYSTEM</h1>
						<p class="wow animated fadeInLeft">If you want to Store your Records, You are at the Right Place! Lets Sign Up and keep Updating!!!</p>
						<div class="row">
							<div class="col-xs-6 col-sm-6 col-md-5">
								<div>
									<a href="register.php" class="polo-btn store wow animated bounceInUp"> Sign Up</a>
								</div>
							</div>
							<div class="col-xs-6 col-sm-6 col-md-5">
								<div>
									<a href="login.php" class="polo-btn store wow animated bounceInUp"> Log In</a>
								</div>
							</div>
				...
				<div class="col-sm-12">
					<div class="row">
						<form role="form" method="post" action="login.php">
							...
							<div class="col-xs-2">
								<button type="Login" class="btn-custom">
